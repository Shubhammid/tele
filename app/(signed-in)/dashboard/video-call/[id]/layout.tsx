...
function Layout({ children }: { children: React.ReactNode }) {
  ...
  if (!client) {
    return (
      <StatusCard
        title="Initilizing client..."
        description="Setting up video call connnection..."
  ...
  if (!call) {
    return (
      ...
      >
        ...
        <div className="text-green-600 font-mono text-xs bg-green-100 px-3 py-1 rounded-full inline-block">
            Call ID: {id}
        </div>
      </StatusCard>
    )
